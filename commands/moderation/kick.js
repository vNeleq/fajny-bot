...
module.exports = {
    ...
    kickMember.send(`Czesc, zostales zkickowany z ${message.guild.name} za: ${reason}`).then(() => 
    kickMember.kick()).catch(err => console.log(err))

    message.channel.send(`**${kickMember.user.tag}** zostal zkickowany`).then(m => m.delete(5000))
